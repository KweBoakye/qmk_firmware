    ...
    switch (get_highest_layer(default_layer_state)) {
        ...
        case _COLEMAK_MOD_DH:
           ...
           case _COLEMAK_DH_GAMING:
			...
			break;
		 	case _QWERTY_GAMING:
			oled_write_P(PSTR(OLED_RENDER_LAYOUT_QWERTY_GAMING), false);
            break;
    }
}
...
static void render_layers(void) {
	...
	static const char PROGMEM custom[4][38] = {
		{0x00, 0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x02, 0x02, 0x02, 0x02, 0x82, 0x82, 0x82, 0x42,
	...
	static const char PROGMEM bottom_layer_inactive_with_second_active[1][38] = {
		{0x0, 0x7f, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x41, 0x41, 0x41, 0x42, 0x42, 0x42, 0x44, 0x44, 0x44, 0x48, 0x48, 0x48, 0x44, 0x44, 0x44, 0x42, 0x42, 0x42, 0x41, 0x41, 0x41, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x7f}
	};	

	static const char PROGMEM first_and_second_layer_active[1][38] = {
		{0x0, 0x7f, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x41, 0x41, 0x41, 0x43, 0x43, 0x43, 0x47, 0x47, 0x47, 0x4f, 0x4f, 0x4f, 0x47, 0x47, 0x47, 0x43, 0x43, 0x43, 0x41, 0x41, 0x41, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x7f}
	};	

	static const char PROGMEM  first_inactive_second_and_third_active[1][38] = {
		{0x0, 0xff, 0x0, 0x44, 0x44, 0x44, 0xae, 0xae, 0xae, 0x1f, 0x1f, 0x1f, 0x3f, 0x3f, 0x3f, 0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x7f, 0x7f, 0x7f, 0x3f, 0x3f, 0x3f, 0x1f, 0x1f, 0x9f, 0xae, 0xae, 0xae, 0x44, 0x44, 0x44, 0x0, 0xff}
	};
    
	static const char PROGMEM second_layer_with_first_and_third_active[1][38] = {
		{0x0, 0xff, 0x0, 0x44, 0x44, 0x44, 0xea, 0xea, 0xea, 0xf1, 0xf1, 0xf1, 0xe3, 0xe3, 0xe3, 0xc7, 0xc7, 0xc7, 0x8f, 0x8f, 0x8f, 0xc7, 0xc7, 0xc7, 0xe3, 0xe3, 0xe3, 0xf1, 0xf1, 0xf1, 0xea, 0xea, 0xea, 0x44, 0x44, 0x44, 0x0, 0xff}
	};

	static const char PROGMEM second_layer_active[1][38] = {
		{0x0, 0xff, 0x0, 0x44, 0x44, 0x44, 0xee, 0xee, 0xee, 0xff, 0xff, 0xff, 0xfe, 0xfe, 0xfe, 0xfc, 0xfc, 0xfc, 0xf8, 0xf8, 0xf8, 0xfc, 0xfc, 0xfc, 0xfe, 0xfe, 0xfe, 0xff, 0xff, 0xff, 0xee, 0xee, 0xee, 0x44, 0x44, 0x44, 0x0, 0xff}
	};

    static const char PROGMEM second_and_third_layer_active[1][38] = {
		{0x0, 0xff, 0x0, 0x44, 0x44, 0x44, 0xee, 0xee, 0xee, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xee, 0xee, 0xee, 0x44, 0x44, 0x44, 0x0, 0xff}
	};

	    static const char PROGMEM third_and_fourth_layer_active[1][38] = {
		{0x0, 0xff, 0x0, 0x44, 0x44, 0x44, 0xee, 0xee, 0xee, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xee, 0xee, 0xee, 0x44, 0x44, 0x44, 0x0, 0xff}
		};

		static const char PROGMEM third_layer_active_and_fourth_inactive[1][38] = {
		{0x0, 0xff, 0x0, 0x44, 0x44, 0x44, 0xea, 0xea, 0xea, 0xf1, 0xf1, 0xf1, 0xe0, 0xe0, 0xe0, 0xc0, 0xc0, 0xc0, 0x80, 0x80, 0x80, 0xc0, 0xc0, 0xc0, 0xe0, 0xe0, 0xe0, 0xf1, 0xf1, 0xf1, 0xea, 0xea, 0xea, 0x44, 0x44, 0x44, 0x0, 0xff}
		};
	...
	switch (get_layer_real_index(get_highest_layer(layer_state))) {
		case 0:
		...
		case 5:
			oled_render_image(1, 38, layer_background_r1, 15, 4, 0);
			oled_render_image(1,38, third_layer_active_and_fourth_inactive,15,5,0);
			oled_render_image(1,38, second_and_third_layer_active,15,6,0);
			oled_render_image(1,38, first_and_second_layer_active,15,7,0);
		break;	
		case 6:
			oled_render_image(2, 38, adjust, 15, 4, 0);
			oled_render_image(1,38, second_layer_active,15,6,0);
			oled_render_image(1,38, first_and_second_layer_active,15,7,0);
		break;
		case 7:
			oled_render_image_partial(38, adjust[0], 15, 4);
			oled_render_image(1,38, third_and_fourth_layer_active,15,5,0);
			oled_render_image(1,38, second_layer_with_first_and_third_active,15,6,0);
			oled_render_image_partial( 38, lower[1], 15, 7);
		break;
			oled_render_image_partial( 38, adjust[0], 15, 4);
			oled_render_image(1,38, third_and_fourth_layer_active,15,5,0);
			oled_render_image(1,38, first_inactive_second_and_third_active,15,6,0);
			oled_render_image(1,38, bottom_layer_inactive_with_second_active,15,7,0);
		// case 5:
		// 	oled_render_image_partial( 38, custom[0], 15, 4);
		// 	oled_render_image_partial( 38, custom[1], 15, 5);
		// 	oled_render_image_partial( 38, custom[2], 15, 6);
		// 	oled_render_image(1, 38, bottom_layer_with_second_active, 15, 7, 0);
		// break;	
		default:
			oled_render_image(4, 38, custom, 15, 4, 0);
		break;
	...
	oled_write_P(PSTR(layer_to_string(layer_state)), false);
}
...
#ifdef PMW3360_ENABLE
  uint16_t pmw3360_cpi = pmw33xx_get_cpi(0);
